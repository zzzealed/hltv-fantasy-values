...
const observer = new MutationObserver(() => {
  ...
  // Disconnect if returned NodeList is empty so we're not running if we don't get anything back
...
// This is really just the rules for the MutationObserver at the top 
